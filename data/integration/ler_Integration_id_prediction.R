...
RL4523 <- subset(RL4523,idents="ler")
...
RL5593 <- subset(RL5593, idents="ler")
...
RL5594 <- subset(RL5594, idents="ler")
RL5594$orig.ident <- "RL5594_scr_ler_r2"

obj <- merge(RL4523, list(RL5593, RL5594))
...
pdf("/home/moliva/root_sc_paper/data/integrated/ler/obj_umi.pdf", width=6, height=6)
...
pdf("/home/moliva/root_sc_paper/data/integrated/ler/umap_ler_lineage.pdf", width=9, height=6)
DimPlot(obj, group.by="predicted.lineage")
dev.off()

pdf("/home/moliva/root_sc_paper/data/integrated/ler/umap_ler_identity.pdf", width=9, height=6)
DimPlot(obj, group.by="predicted.identity")
dev.off()

pdf("/home/moliva/root_sc_paper/data/integrated/ler/umap_ler_orig.ident.pdf", width=9, height=6)
DimPlot(obj, group.by="orig.ident")
dev.off()

saveRDS(obj,"/home/moliva/root_sc_paper/data/integrated/ler/integrated_ler_predicted_id.rds")
